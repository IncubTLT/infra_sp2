...
1. Необходимо установить Docker по ссылке: https://www.docker.com/products/docker-desktop/

2. Клонировать проект на свою машину

3. Открыть в терминале директорию infra_sp2/api_yamdb/infra

4. Запустить сборку образа проекта командой docker-compose up -d --build
___
...
- [![Join Telegram](https://img.shields.io/badge/My%20Telegram-Join-blue)](https://t.me/Incub163)
___
